...
$(document).ready(function() {
	$("#launchPuzzleSolvingGame_form").validate( {
		event: "blur",
		rules : {
			"gameInfo.gameName" : {
				required : true,
...
<s:form id="launchPuzzleSolvingGame_form" action="launchPuzzleSolvingGame" theme="simple">
	...
	<select id="qrNum" class="myselectstyle_inline" name="gameInfo.qrNum" onchange="change_qr_num()">
		<option value="1">
			1
		</option>
		<option value="2">
	...
	<s:textfield cssClass="myinputstyle" name="gameInfo.gameName" size="30"></s:textfield>
	</li>
	...
	<select class="myselectstyle_inline" name="gameInfo.difficultyLevel">
		<option value="1">
			1
		</option>
		<option value="2">
	...
	<select class="myselectstyle_inline" name="gameInfo.terrainLevel">
		<option value="1">
			1
		</option>
		<option value="2">
	...
	<s:textarea name="gameInfo.longDescription" cols="77" rows="10"></s:textarea>
	...
	<s:textarea name="gameInfo.hint" cols="77" rows="10"></s:textarea>
	...
	<div id="tiny_mce_textarea_div_1">
		...
		<s:textarea id="tiny_mce_textarea_1" name="qrRawContentList[0]" rows="80" cols="80" cssStyle="width: 710px; height: 300px">
		</s:textarea>
	</div>
	...
	<div id="tiny_mce_textarea_div_2">
		...
		<s:textarea id="tiny_mce_textarea_2" name="qrRawContentList[1]" rows="80" cols="80" cssStyle="width: 710px; height: 300px">
		</s:textarea>
	</div>
	
	<div id="tiny_mce_textarea_div_3">
		<label class="mylabelstyle">QR #3</label><br />
		<s:textarea id="tiny_mce_textarea_3" name="qrRawContentList[2]" rows="80" cols="80" cssStyle="width: 710px; height: 300px">
		</s:textarea>
	</div>
	
	<div id="tiny_mce_textarea_div_4">
		<label class="mylabelstyle">QR #4</label><br />
		<s:textarea id="tiny_mce_textarea_4" name="qrRawContentList[3]" rows="80" cols="80" cssStyle="width: 710px; height: 300px">
		</s:textarea>
	</div>
	
	<div id="tiny_mce_textarea_div_5">
		<label class="mylabelstyle">QR #5</label><br />
		<s:textarea id="tiny_mce_textarea_5" name="qrRawContentList[4]" rows="80" cols="80" cssStyle="width: 710px; height: 300px">
		</s:textarea>
	</div>
