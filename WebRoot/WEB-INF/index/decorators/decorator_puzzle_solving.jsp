...
<head>
    ...
    <link href="<%=request.getContextPath() %>/css/puzzlesolving_decorator_special.css" rel="stylesheet" type="text/css" />
      ...
      <div id="right-column">
        <div id="navigation-block">  
          <ul id="sliding-navigation">
            <li class="sliding-element"><h3>Puzzle Solving</h3></li>
            <li class="sliding-element"><a href="<%=request.getContextPath()%>/puzzle-solving-index.jsp">Getting started</a></li>
            <li class="sliding-element"><a href="<%=request.getContextPath()%>/Seek.jsp">Seek a game</a></li>
            <li class="sliding-element"><a href="<%=request.getContextPath()%>/LaunchPuzzleSolvingGame.jsp">Launch a game</a></li>  
