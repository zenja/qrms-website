      ...
      <div id="right-column">
        <div id="navigation-block">  
          <ul id="sliding-navigation">
            <li class="sliding-element"><h3>QR Marks The Spot</h3></li>
            <li class="sliding-element"><a href="<%=request.getContextPath()%>/normal/getting-started.jsp">Getting started</a></li>
            <li class="sliding-element"><a href="<%=request.getContextPath()%>/inspiring_mode/index.jsp">Inspiring Mark!</a></li> 
            <li class="sliding-element"><a href="<%=request.getContextPath()%>/puzzle-solving-index.jsp">Puzzle Solving</a></li>
            <li class="sliding-element"><a href="<%=request.getContextPath()%>/conquest_and_defence/index.jsp">Conquest &amp; Defence</a></li>
