...
<head>
    ...
    <link href="<%=request.getContextPath() %>/css/candd_decorator_special.css" rel="stylesheet" type="text/css" />
      ...
      <div id="right-column">
        <div id="navigation-block">  
          <ul id="sliding-navigation">
            ...
            <li class="sliding-element"><a href="<%=request.getContextPath()%>/conquest_and_defence/index.jsp">Getting started</a></li>
