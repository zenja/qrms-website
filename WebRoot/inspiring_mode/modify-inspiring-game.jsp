...
if(session.getAttribute("user") == null) {
	response.sendRedirect(request.getContextPath() + "/normal/login.jsp?previousPageURL=inspiring_mode/showModifyInspiringGamePage.action?gameId=" + request.getParameter("gameId"));
}
%>
...
$(document).ready(function() {
	$("#modifyInspiringGame_form").validate( {
		event: "blur",
		rules : {
...
<!-- ************Forms************ -->
<s:form id="modifyInspiringGame_form" action="modifyInspiringGame" method="POST" theme="simple">
...
<s:textarea name="newGameInfo.hint" rows="10" cssStyle="width: 710px;" value="%{oldGameInfo.hint}"></s:textarea>
</p>
...
<s:textarea id="tiny_mce_textarea" name="newQrRawContent" rows="80" cols="80" cssStyle="width: 710px; height: 500px" value="%{oldGameInfo.qrContent.content}">
</s:textarea>
</p>
