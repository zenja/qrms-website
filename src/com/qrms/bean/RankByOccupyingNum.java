...
/**
 * RankByOccupyingNum entity. @author MyEclipse Persistence Tools
 */

public class RankByOccupyingNum implements java.io.Serializable {
	...
	/** default constructor */
	public RankByOccupyingNum() {
	}

	/** full constructor */
	public RankByOccupyingNum(Integer userid, Integer exp, Integer setupnum,
